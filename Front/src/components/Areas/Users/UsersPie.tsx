...
const UsersPie: React.FC<UserPieProps> = ({ activeUsers, inactiveUsers}) => {
    const [series, setSeries] = useState([activeUsers, inactiveUsers]);
...
useEffect(() => {
    setSeries([activeUsers, inactiveUsers]);
